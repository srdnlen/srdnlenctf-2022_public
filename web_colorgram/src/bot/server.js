...
const PORT = 8888
const URL_COLORGRAM = process.env['URL_COLORGRAM'] || "http://colorgram-app:80/";
const USERNAME = process.env['USERNAME'] || "admin";
const PASSWORD = process.env['PASSWORD'] || "srdnlen{N1ce_J0B_s0rry_f0r_th1s_X55_4nd_h77p0nly_bypass}";
